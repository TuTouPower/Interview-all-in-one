...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yUqcPlbC7BA8K7uvbjMzlZDYPwYMZEbDxqjqZvU4YmdlxmKJmz6kvsg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34ykr1lnBzhNotSn2QqeaK900M2fdR9NRhNJjt7KgTsH4hHX69utfC9iag/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

那么问题就来了，多个线程如果竞争共享资源，如果不采取有效的措施，则会造成共享数据的混乱。

我们做个小实验，创建两个线程，它们分别对共享变量 `i` 自增 `1` 执行 `10000` 次，如下代码（虽然说是 C++ 代码，但是没学过 C++ 的同学也是看到懂的）：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yicxLZxklqpnQJcPQVprrxVXnoBzxO3QXKtZkqI8GAyMxtp2kibk541VA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34ycbfdlYTI8NxrEIboJP2rbWVEImGkWhjiafS9rbKu1wTQsFNjL7Ld16w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34y4CUp2YtpUAbQrXfc9rbzhmYColm2QHFic6ibuCcSOAicnu9P6qzvcr5ew/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yN1iadgAqAS7xRP2Do4SnFFGIqCKQ5gsGUANdJib1CPjjJ1Ql6XPJd6Mw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34y0RZUFcmKNS1zgzPD9aVmmDC3giafUaSbibwUIeibwAHrXW7OgoIibbPmuQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34ygtOPqTjLt0LmM8emO2BH7CH1qUUeA3JxkUgQy9oicaYmOHkDvX7ablQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)忙等待锁的实现
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34y0QwO5qiazQRtKqFSIGzvL0gvQictrCQbo4sdGbGXd1xc4WbibiaA94zWXg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)无等待锁的实现
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yPBPPl3NvLWxNFicrLXJ0ZV3Bib2hlyj5GMZjL6qv3BQyCvcEGBSTMdXA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)信号量与火车轨道

> 操作系统是如何实现 PV 操作的呢？

信号量数据结构与 PV 操作的算法描述如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yu5wTSwxUBcCcrnQ0ABfabnibUgww8Q3lqRsUa6G5p4tKJrPdIwIoEwg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)PV 操作的算法描述
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yyRbhsR19SssE6jMicnibujjJd2p88Kib1bzU61yicQvj4qBBM31ogNzF7g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)生产者-消费者模型
...
![图片](D:\Download\桌面\知识体系\图片\哲学家就餐.png)
...
![图片](D:\Download\桌面\知识体系\图片\哲学家就餐 方案二问题.webp)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yj2GunIuxMZhBMRUgWUkPicUYnxBLYC5Ksibib9Qibohxnbp62R9ER5KIIA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)方案三可解决问题
...
![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)方案四也可解决问题
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yQtE10JWM8RK1E2TF0PTegQnse8a0j7icBcibLfF84m4uFaEcMzwFtdWg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34ydvCpsPkjHiaTzn0E2s6EUWdMicSPJO9WicicdVLYbxxOCegCAxvz54hWcw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcJWrfgAR82HEMZFficYr34yyG6jj8utdEianOj8cj1DCIEXWAJ9Za7VCyk7kAFzpgajppWer21pOPw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
